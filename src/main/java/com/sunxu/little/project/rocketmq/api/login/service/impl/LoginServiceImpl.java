package com.sunxu.little.project.rocketmq.api.login.service.impl;
...
import com.sunxu.little.project.rocketmq.api.login.enums.FirstLoginStatusEnum;
import com.sunxu.little.project.rocketmq.api.login.service.LoginService;
...
public class LoginServiceImpl implements LoginService {
    ...
    private void sendFirstLoginMessage(LoginRequestDTO loginRequestDTO) {
        ...
        try {
            ...
            LOGGER.error("send login success notify message fail, error message:{}", e.getMessage(), e);
        }
    }
